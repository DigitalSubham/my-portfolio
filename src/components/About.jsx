...
const About = () => {
  return (
    <div
      name="about"
      className="w-full bg-gradient-to-b from-gray-800 to-black text-white flex flex-col sm:flex-row"
    >
      <div className="max-w-screen-lg p-2 mx-auto flex flex-col justify-center w-full sm:w-1/2">
        ...
        <p className="text-xl mt-5 sm:mt-0">
          ...
          Breaking down intricate technicalities into digestible content brings
          me joy. A perpetual learner, I eagerly embrace emerging technologies,
          determined to contribute meaningfully to the tech community's
          discourse. The journey ahead holds the promise of continuous growth
          and positive impact.
        </p>
      </div>
